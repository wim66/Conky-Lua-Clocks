...
function conky_main_box()
	...
	{x=10,y=10,w=200,h=200, colour= { {0,0xFFFFFF,1}, {1,0x3D3D3D,1} }, radial_gradient= {100,0,50,100,0,200},
        corners = { {"circle",100} },},
        {x=20,y=20,w=180,h=180, colour= { {0,0xFFFFFF,1}, {1,0x3D3D3D,1} }, radial_gradient= {90,200,25,90,180,180},
        corners = { {"circle",90} },}, 
	


        {x=23,y=23,w=174,h=174, colour= { {0,0xB3D4FF,1}, {0.2,0x206FD4,1}, {1,0x113B70,1} }, radial_gradient= {87,200,25,87,180,180},
        corners = { {"circle",87} },},

        {x=23,y=23,w=174,h=174, colour= { {0,0x000000,1}, {1,0x000000,0} }, radial_gradient= {87,87,87,87,87,83},
        corners = { {"circle",87} },},


        {x=53,y=27,w=114,h=114, colour= { {0,0xFFFFFF,0.75}, {1,0xFFFFFF,0} }, linear_gradient= {57,0,57,114},
