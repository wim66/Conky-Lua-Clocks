...
function conky_main_box()
	...
	{	draw_me=true,
	x=355,y=61,w=174,h=174,
		colour= "custom", radial_gradient= {87,210,25,87,190,188},
        corners = { {"circle",86} },
	},

		-- top glare
	{	draw_me=true,
	x=384,y=61,w=116,h=116, 
	...
	{	draw_me=true,
	x=355,y=61,w=174,h=174,
		colour= { {0,0x000000,0.5}, {1,0x003E00,0} }, radial_gradient= {87,87,87,87,87,82},
        corners = { {"circle",86} },border=4,
	},

		--outer border
	{	draw_me=true,
	x=350,y=56,w=184,h=184,
		colour= "custom4", linear_gradient= {0,0,0,184},
        corners = { {"circle",92} },border=8,
	},
...
function draw_box(cr,t)
    ...
    if Clock_Face_Color == "black" then 	clock_face = { {0,0xFFFFFF,1}, {0.2,0x1C1C1C,0.75}, {1,0x000000,0.8} } --base
						clock_face2 = { {0,0x000000,0.8}, {1,0x000000,0} }			--inner
						clock_face3 = { {0,0xFFFFFF,0.66}, {0.25,0xFFFFFF,0.66}, {1,0x000000,0} }--top
                        border_color = { {0,0x000000,0.75}, {0.5,0x454545,0.9}, {1,0x000000,0.75} } end  --outer border
                                                                                       
	if Clock_Face_Color == "green" then 	clock_face = { {0,0x03F404,1}, {0.2,0x1C1C1C,0.75}, {1,0x000000,0.8} } --base
						clock_face2 = { {0,0x03F404,0.8}, {1,0x000000,0} }			--inner
						clock_face3 = { {0,0xFFFFFF,0.66}, {0.25,0x03F404,0.66}, {1,0x000000,0} }--top
                        border_color = { {0,0x003E00,1}, {0.5,0x03F404,1}, {1,0x003E00,1} } end --outer border
	...
	if Clock_Face_Color == "pink" then 	clock_face = { {0,0xFFC1E5,1}, {0.2,0xCB5698,1}, {1,0xCB5698,0.66} }
						...
						clock_face3 = { {0,0xFFC1E5,1},{1,0xFFC1E5,0} }
                        border_color = { {0,0xFF6CBF,0.25}, {0.5,0xFF6CBF,0.9}, {1,0xFF6CBF,0.25} } end --outer border
    ...
    if t.colour == "custom4" then t.colour = border_color end
